...
// ANSWER: No, The way this for loop is written prevents it from running more than four times.  It cannot be simplified beyond that.
...
// ANSWER: every individual function would be dependent on the size the string.
